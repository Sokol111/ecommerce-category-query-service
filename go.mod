...
require (
	github.com/Sokol111/ecommerce-catalog-service-api v1.1.0
	github.com/Sokol111/ecommerce-category-query-service-api v1.1.0
	github.com/Sokol111/ecommerce-commons v0.5.1
