...
require (
	github.com/Sokol111/ecommerce-catalog-service-api v1.0.7
	github.com/Sokol111/ecommerce-category-query-service-api v1.0.11
	github.com/Sokol111/ecommerce-commons v0.3.7
