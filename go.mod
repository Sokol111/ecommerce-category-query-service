...
require (
	...
	github.com/Sokol111/ecommerce-commons v0.5.4
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/v2/mongo/otelmongo v0.0.0-20260327131730-b24435fbe205 // indirect
